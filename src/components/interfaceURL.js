...
export const get_major = "/data/get_major.json";
export const get_subject = "/data/get_subject.json";
export const get_student1 = "data/get_student1.json";

export const get_course = "data/get_course.json";
export const get_score = "data/get_score.json";

export const get_award = "data/get_award.json";
