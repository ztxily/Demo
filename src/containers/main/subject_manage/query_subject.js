...
class QuerySubject extends React.Component {
  ...
  render(){
    ...
    return(
      <div>
        <BreadcrumbCustom pathList={['学科管理','查询学科']}></BreadcrumbCustom>
        <div className="class-manage-content">
          <Row>
            <Col span={24}>
              ...
              <Button type="primary" className="f-l" onClick={this.showAllClass.bind(this)}>所有学科</Button>
            </Col>
          </Row>
