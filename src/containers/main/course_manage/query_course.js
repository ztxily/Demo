...
class QueryCourse extends React.Component {
  constructor(){
    super()
    this.state = {
  ...
  render(){
    ...
    return(
      <div>
        <BreadcrumbCustom pathList={['课程管理','查询课程']}></BreadcrumbCustom>
        <div className="class-manage-content">
          <Row gutter={8}>
            <Col  {...ColProps} >
              <Button type="primary"  onClick={this.showAllClass.bind(this)}>所有课程</Button>
            </Col>  
            <Col  {...ColProps} >
              <Search
