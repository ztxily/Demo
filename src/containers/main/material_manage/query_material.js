...
class QueryMateria extends React.Component {
  constructor(){
    super()
    this.state = {
  ...
  render(){
    ...
    return(
      <div>
        <BreadcrumbCustom pathList={['学籍管理','查询学籍']}></BreadcrumbCustom>
        <div className="class-manage-content">
          <Row gutter={8}>
            <Col  {...ColProps} >
              <Button type="primary"  onClick={this.showAllClass.bind(this)}>所有专业</Button>
            </Col>  
            <Col  {...ColProps} >
              <Search
